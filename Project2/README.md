...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	// Method 1: Search and navigate on the site
	@Test(priority = 1)
	public void searchAndNavigate() throws InterruptedException {
		// ----search---- //
		// Type "Stars" in the search bar
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@aria-hidden='false']")).sendKeys("Stars");
	...
	// Method 3: Navigate Navbar: E-books
	@Test(priority = 3)
	...
	// Method 4: Navigate Navbar: images
	@Test(priority = 4)
	...
	// Method 5: Navigate Navbar: sounds
	@Test(priority = 5)
	public void sounds() throws InterruptedException {
		// Downloads
		driver.findElement(By.xpath("//span[contains(.,'Downloads')]")).click();
		Thread.sleep(2000);
	...
	// Method 6: Navigate Navbar: Audiences
	@Test(priority = 6)
	public void audiences() throws InterruptedException {
		// NASA Audiences
		driver.findElement(By.xpath("//span[contains(.,'NASA Audiences')]")).click();
		Thread.sleep(2000);
